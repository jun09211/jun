...
public class ViewMusic {
	...
	public int printMenu() {
		...
		System.out.println("2. 첫 위치에 곡추가");
	...
	public String searchMusic() {
		System.out.print("찾는 곡을 입력해주세요 : ");
		String title=sc.next();
		return title;
	}

	public void searchMusic2(Music music) {
		// TODO Auto-generated method stub
		System.out.println("찾는 곡의 가수는 : "+music.getSinger());
	}
